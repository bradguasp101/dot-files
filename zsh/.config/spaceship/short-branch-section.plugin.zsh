...
SPACESHIP_SHORT_BRANCH_PREFIX="${SPACESHIP_SHORT_BRANCH_PREFIX=" "}"
SPACESHIP_SHORT_BRANCH_SUFFIX="${SPACESHIP_SHORT_BRANCH_SUFFIX=" "}"
SPACESHIP_SHORT_BRANCH_COLOR="${SPACESHIP_SHORT_BRANCH_COLOR=magenta}"
